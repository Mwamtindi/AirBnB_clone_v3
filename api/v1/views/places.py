...
def places_per_city(city_id=None):
    """
       The places route to handle http method for requested places by city
    """
...
def places_with_id(place_id=None):
    """
        The places route to handle http methods for given place
    """
...
def places_search():
    """
       The places route to handle http method for request to search places
    """
